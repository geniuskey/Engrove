...
describe('parseConfig', () => {
  it('retains every configuration field when composing the schema modules', () => {
    const configured = parseConfig({
      ...
      API_RATE_LIMIT_TOKEN_REQUESTS: '150',
      API_RATE_LIMIT_SESSION_REQUESTS: '450',
      API_RATE_LIMIT_ANONYMOUS_REQUESTS: '60',
    ...
    expect(Object.keys(configured).sort()).toEqual(
      [
        ...
        'ARGON2_MEMORY_KIB',
        'ARGON2_PARALLELISM',
        'API_RATE_LIMIT_ANONYMOUS_REQUESTS',
        'API_RATE_LIMIT_SESSION_REQUESTS',
        'API_RATE_LIMIT_TOKEN_REQUESTS',
