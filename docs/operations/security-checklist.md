...
- [ ] OIDC uses a confidential client, exact redirect URI, PKCE S256, restricted domains or pre-provisioned users, least-privilege default role, and a tested secret-rotation procedure.
